...
## Description
This script is a simple game where you can select a difficulty and guess a number

## Output
The script produces a corect result to verify is you win or lose
...
- Simple game if you bored
- You can input 2 values/run
