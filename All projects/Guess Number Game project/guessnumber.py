...
like,EASY,NORMAL,HARD and EXTREME.
...
game_mode = str(input('Please enter game difficulty(EASY-e,NORMAL-n,HARD-h,EXTREME-ex): '))
game_mode = game_mode.lower() # Make the string (input) from this:"HeLLo" to this "hello"

if game_mode == 'e' or game_mode == 'n' or game_mode == 'h' or game_mode == 'ex': # If u enter a difficulty on a correct way
