...
## Description
This script is a simple Machine Learning, what learns to make simple math calculations, like 2 + 3.

## Output
The script produces ML's performance trained
...
- Simple ML example
- After training, this ML can get 2 inputs for addition
