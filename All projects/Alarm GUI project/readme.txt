...
## Description
This script is also a GUI for an alarm, which has options like any regular alarm
...
- Can playing a sound when the alarm is ready (optional)
- Costum message when the alarm is ready
