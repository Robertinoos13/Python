# Script Name
Guess Colors Order Game

## Description
This script is a game using TKINTER where you can guess the colors order

## Output
The script produces a GUI, perfect for a Guess The Color Order game
